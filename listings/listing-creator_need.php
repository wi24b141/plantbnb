...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // VALIDATION 1: Ensure listing type is 'need' for this form
    if ($listingType !== 'need') {
    ...
    if (empty($errors)) {
        ...
        try {
            ...
            // Now we insert the plant details into the plants table
            // Each listing must have at least one plant entry
            // The plant entry is linked to the listing by listing_id
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <!-- Force this form to create 'need' listings only -->
                            ...
                            <!-- For 'Need' listings we don't collect photos or care sheets -->
